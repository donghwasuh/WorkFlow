...
class dummyMainProcess:
    def __init__(self):
        ...
        self.mon_deque = collections.deque()
        self.save_deque = collections.deque()


if __name__ == '__main__':
    dm = dummyMainProcess()
    pt = ProcessTask( 'test', 'python /home/mysqli/EventFlow/EventFlowSingle/testProgram/test_program_out.py test', dm, debugMode=True)
    pt.start()
    while True:
        pt.put_queue("test\n")
        time.sleep(1)
        print 'backup_queue : ', pt.backup_deq
